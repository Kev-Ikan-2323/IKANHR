...
export async function getCurrentUser(req, res) {
  ...
  return {
    ...
    isManager:           permissions.indexOf('manager') > -1 || ledTeams.length > 0 || coledTeams.length > 0 || directReports.length > 0,
